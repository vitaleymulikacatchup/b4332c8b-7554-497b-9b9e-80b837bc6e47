...
export const metadata: Metadata = {
  title: "Bean & Brew - Specialty Coffee Shop",
  description: "Discover premium specialty coffee, handcrafted drinks, and a welcoming café atmosphere at Bean & Brew. Visit us today.",
  keywords: ["coffee shop", "specialty coffee", "cafe", "espresso", "latte", "cappuccino"],
  openGraph: {
    title: "Bean & Brew - Premium Specialty Coffee",
    description: "Experience exceptional coffee in our cozy café. Fresh roasted beans, expert baristas, and warm hospitality.",
    siteName: "Bean & Brew",
    type: "website"
  },
  robots: {
